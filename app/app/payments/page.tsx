  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "awaiting_payment":
        return (
          <span className="inline-flex items-center px-2.5 py-1 text-xs font-semibold rounded-full bg-yellow-400/10 text-yellow-400 border border-yellow-400/20 animate-pulse">
            Awaiting
          </span>
        );
      case "detected":
      ...
      case "manual_review":
        return (
          <span className="inline-flex items-center px-2.5 py-1 text-xs font-semibold rounded-full bg-amber-500/10 text-amber-300 border border-amber-500/20">
            Manual Review
          </span>
        );
      default:
