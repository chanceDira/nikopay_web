    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="niko-panel p-5 sm:p-6">
          <p className="text-xs font-medium text-niko-muted">USDT received</p>
          <h3 className="mt-2 font-mono text-2xl font-bold text-foreground">
            {formatUsdt(metrics.matchedUsdt)}
          </h3>
          <div className="mt-3 flex items-center justify-between border-t border-niko-border/30 pt-3 text-xs text-niko-muted">
        ...
        <div className="niko-panel p-5 sm:p-6">
          <p className="text-xs font-medium text-niko-muted">Paid out</p>
        ...
        <div className="niko-panel p-5 sm:p-6">
          <p className="text-xs font-medium text-niko-muted">Fees collected</p>
          <div className="mt-2 space-y-1">
            {fees.length === 0 ? (
              <h3 className="font-mono text-2xl font-bold text-foreground">
                —
        ...
        <div className="niko-panel p-5 sm:p-6">
          <p className="text-xs font-medium text-niko-muted">Success rate</p>
          <h3 className="mt-2 font-mono text-2xl font-bold text-foreground">
      ...
      <div className="niko-panel p-5 sm:p-6">
        <h4 className="mb-6 text-sm font-semibold text-foreground">By chain</h4>
        ...
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
          ...
          <div className="space-y-3">
            ...
            <div className="flex h-32 items-end gap-2 border-b border-niko-border/30 px-1 pt-4">
              {STATUS_BARS.map((bar) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className="max-w-full truncate font-mono text-[9px] tracking-tight text-niko-muted">
                      {bar.label}
                    </span>
                  </div>
                );
