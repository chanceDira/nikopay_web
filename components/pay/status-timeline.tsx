...
export function StatusTimeline({ id }: StatusTimelineProps) {
  ...
  if (!intent) {
    return (
      <div className="text-center py-16 space-y-4">
        ...
        <Link
          href="/app/payments"
          className="inline-block mt-4 px-4 py-2 border border-niko-border hover:border-niko-teal/30 hover:bg-niko-surface rounded-xl text-sm font-semibold transition-all"
        >
  ...
  const getStepStyles = (state: string) => {
    switch (state) {
      ...
      case "warning":
      case "expired":
        return "bg-amber-500/10 text-amber-400 border-amber-500";
      default:
      ...
      >
        ...
        {intent.status === "paid" && (
          <Link
            ...
            className="self-center px-3.5 py-1.5 bg-niko-teal text-niko-navy font-bold text-xs rounded-lg hover:bg-niko-teal-bright transition-colors"
          >
            Receipt
          </Link>
        )}
      ...
      <div className="relative border border-niko-border bg-background/50 rounded-md p-6 md:p-8 space-y-8">
        <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex md:flex-col items-start gap-4 md:text-center md:items-center">
            <div
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-bold transition-all ${getStepStyles(getStepState(1))}`}
            >
          ...
          <div className="flex md:flex-col items-start gap-4 md:text-center md:items-center">
            <div
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-bold transition-all ${getStepStyles(getStepState(2))}`}
            >
          ...
          <div className="flex md:flex-col items-start gap-4 md:text-center md:items-center">
            <div
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-bold transition-all ${getStepStyles(getStepState(3))}`}
            >
          ...
          <div className="flex md:flex-col items-start gap-4 md:text-center md:items-center">
            <div
              className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-bold transition-all ${getStepStyles(getStepState(4))}`}
            >
        ...
        <div className="rounded-md border border-niko-border bg-niko-surface/40 p-5 space-y-4">
          ...
          <div className="space-y-3 text-xs font-mono">
            <div>
              ...
              <p className="p-2.5 rounded-lg bg-background border border-niko-border/60 text-foreground break-all">
                {intent.id}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="p-2.5 rounded-lg bg-background border border-niko-border/60 text-foreground font-bold">
                {intent.msisdn}
              </p>
            </div>
            ...
            {intent.depositTx && (
              <div>
                ...
                <p
                  className="p-2.5 rounded-lg bg-background border border-niko-border/60 text-niko-teal-bright break-all truncate hover:text-clip"
